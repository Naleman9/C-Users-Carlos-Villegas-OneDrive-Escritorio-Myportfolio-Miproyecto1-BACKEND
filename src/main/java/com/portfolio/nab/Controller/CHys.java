...
import com.portfolio.nab.Dto.dtoHys;
import com.portfolio.nab.Entity.hys;
import com.portfolio.nab.Security.Controller.Mensaje;
import com.portfolio.nab.Service.Shys;
...
public class CHys {
    ...
    public ResponseEntity<hys> getById(@PathVariable("id") int id) {
        if (!shys.existsById(id)) {
            return new ResponseEntity<hys>((MultiValueMap<String, String>) new Mensaje("no existe"), HttpStatus.NOT_FOUND);
        }
